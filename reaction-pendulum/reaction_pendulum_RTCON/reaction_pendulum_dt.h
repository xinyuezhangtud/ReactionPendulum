...
static DataTypeTransition rtBTransitions[] = {
  { (char_T *)(&reaction_pendulum_B.Control), 0, 0, 18 }
  ,

  { (char_T *)(&reaction_pendulum_DW.Memory1_PreviousInput), 0, 0, 2 },

  { (char_T *)(&reaction_pendulum_DW.PlotState_PWORK.LoggedData[0]), 11, 0, 4 }
};
...
static DataTypeTransition rtPTransitions[] = {
  { (char_T *)(&reaction_pendulum_P.SFunction_P2_Size[0]), 0, 0, 26 },
