 ...
 * C source code generated on : Mon May  1 14:57:07 2023
 *
...
void reaction_pendulum_step(void)
{
  ...
  if (reaction_pendulum_P.ResetEncoders2_CurrentSetting == 1) {
     ...
     */
    reaction_pendulum_B.Control = sin(6.2831853071795862 *
...
void reaction_pendulum_initialize(void)
{
  ...
  rtmSetTFinal(reaction_pendulum_M, 40.0);
  ...
  /* External mode info */
  reaction_pendulum_M->Sizes.checksums[0] = (1531559946U);
  reaction_pendulum_M->Sizes.checksums[1] = (2177202554U);
  reaction_pendulum_M->Sizes.checksums[2] = (386329335U);
  reaction_pendulum_M->Sizes.checksums[3] = (1511663529U);
  ...
  /* register each child */
  {
    ...
    /* Level2 S-Function Block: reaction_pendulum/<S1>/S-Function (rtdacusb2_rpend_dd) */
    {
      SimStruct *rts = reaction_pendulum_M->childSfunctions[0];
